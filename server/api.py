...
def set_middlewares(app: FastAPI) -> None:
    ...
    def type_error_handler(request: Request, exc: RequestValidationError) -> ORJSONResponse:
    ...
    def domain_error_handler(request: Request, exc: ServiceError) -> ORJSONResponse:
        return ORJSONResponse(
            status_code=400,
    ...
    def error_handler(request: Request, exc: Error) -> ORJSONResponse:
        return exc.render()

    @app.exception_handler(HTTPException)
    def fastapi_error_handler(request: Request, exc: HTTPException) -> ORJSONResponse:
        return ORJSONResponse(
